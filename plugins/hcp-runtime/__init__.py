...
This plugin uses only documented Hermes extension surfaces: system prompt sections,
model-call context injection, tool/API observers, and the bounded pre_verify gate.
It does not patch Hermes internals or expose model chain-of-thought.
"""
